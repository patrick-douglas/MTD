...
class DistMatrix:
    ...
    def compute_f_dists( self ):
        if args.load_pickled_dist_matrix_f:
            ...
            self.f_cdist_matrix = spd.squareform( np.matrix( pd.read_csv( args.load_dist_matrix_f, sep ='\t', index_col = None, header = None  ) ) )
        else:
    ...
    def compute_s_dists( self ):
        if args.load_pickled_dist_matrix_s:
            ...
            self.s_cdist_matrix = spd.squareform( np.matrix( pd.read_csv( args.load_dist_matrix_s, sep ='\t', index_col = None, header = None  ) ) )
        else:
            done = False
