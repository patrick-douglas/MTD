...
Examples:
  ...
  $0 --env R412 --isolated --out report.tsv
EOF
}
...
out_file <- Sys.getenv("CHECK_OUT", "R412_package_health.tsv")
...
pkgs <- c(
  "remotes", "BiocManager", "httr", "lattice", "Matrix",
  "SummarizedExperiment", "DelayedArray", "MASS", "ggplot2",
  "ade4", "biomformat", "multtest", "vegan", "RProtoBufLib",
  "cytolib", "flowCore", "DBI", "AnnotationDbi",
  "SingleCellExperiment", "phyloseq", "curl", "annotate",
  "BiocFileCache", "yulab.utils", "ggfun", "gtable",
  "aplot", "lme4", "TMB", "GenomicFeatures", "metagenomeSeq",
  "biomaRt", "ggtree", "fgsea", "R.methodsS3", "R.oo",
  "R.utils", "GO.db", "GOSemSim", "DOSE", "scatterpie",
  "ggnewscale", "tidyverse", "sctransform", "tidytree",
  "clusterProfiler", "gson", "processx", "lifecycle",
  ...
  "futile.logger", "RColorBrewer", "DO.db", "forcats",
  "conflicted", "org.Hs.eg.db", "graph", "Rgraphviz",
  "KEGGgraph", "pathview", "prettydoc", "genefilter",
  "DESeq2", "AnnotationForge", "glmGamPoi", "MAST",
  "microbiome", "pacman", "VennDiagram", "hdf5r",
  "ggupset", "doParallel", "ANCOMBC", "RcppArmadillo"
)
