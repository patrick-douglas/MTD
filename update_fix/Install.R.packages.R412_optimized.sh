...
bioc_pkgs_phase1 <- c(
  ...
  "annotate", "AnnotationForge", "GO.db", "DO.db",
  # Official OrgDb packages for model organisms represented in HostSpecies.csv.
  # Non-model organisms continue to use reference-matched custom OrgDb packages.
  "org.Bt.eg.db", "org.Ce.eg.db", "org.Cf.eg.db", "org.Dm.eg.db",
  "org.Dr.eg.db", "org.Gg.eg.db", "org.Hs.eg.db", "org.Mm.eg.db",
...
important_versions <- c(
  ...
  "org.Mmu.eg.db", "org.Pt.eg.db", "org.Rn.eg.db", "org.Sc.sgd.db",
  "org.Ss.eg.db",
  "DESeq2", "phyloseq", "microbiome", "mia",
